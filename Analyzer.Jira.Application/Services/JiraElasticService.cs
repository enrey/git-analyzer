...
namespace Analyzer.Jira.Application.Services
{
    public class JiraElasticService
    {
        ...
        public JiraElasticService(IOptionsMonitor<JiraConfig> jiraConfig, JiraService jiraService, ILogger<JiraElasticService> logger)
        {
        ...
        {
            var settings = new ConnectionSettings(new Uri(_jiraConfig.ElasticSearchUrl)).DefaultIndex(INDEX_NAME);
